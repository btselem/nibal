...
[](svg/#intro-pre.svg/-0.02,1.21,1.52/+nibal2023,~displacement)
[](map/#31.41661,34.37347,10.01,37.6,0.0/~labels_he,~Gaza_border_dash,~Gaza_border_base)
הרג של עשרות אלפי בני אדם, פציעה של מאות אלפים, הרס אדיר של מבנים ותשתיות חיוניות והרעבה של מרבית האוכלוסייה – כל אלו מתבצעים באופן שיטתי, כחלק ממתקפה מתואמת, שמטרתה להחריב את כלל מרכיבי החיים ברצועה.
