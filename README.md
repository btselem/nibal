...
[](svg/#intro-pre.svg/-0.02,1.21,1.52/+nibal2023,~displacement)
[](map/#31.41661,34.37347,10.01,37.6,0.0/~labels_he)
לאורך שנתיים, ישראל הורתה לתושבי הרצועה לעקור שוב ושוב ממקומם. בערך 1.9 מיליון פלסטינים, המהווים כ-90% מאוכלוסיית הרצועה, נעקרו לפחות פעם אחת מאז אוקטובר 2023, לעתים קרובות לאחר שאיבדו בני משפחה ואת מרבית רכושם.
